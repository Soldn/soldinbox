...
public class BoxData {
    ...
    public void spawn() {
        ...
        if (state instanceof Container container) {
            ...
            for (LootEntry le : loot) {
                ...
                // attach chance as lore for editor
    ...
    public void openEditor(Player player) {
        // create separate editing inventory so we can control save/cancel
        Inventory inv = Bukkit.createInventory(new EditorHolder(id), 27,
